...
// --------- static
define('_CSS', Dfi\App\Config::getString('http.static') . 'css/');
define('_IMG', Dfi\App\Config::getString('http.static') . 'img/');
define('_IMG_LAYOUT', _IMG . 'layout/');
define('_SWF', Dfi\App\Config::getString('http.static') . 'swf/');
define('_XML', Dfi\App\Config::getString('http.static') . 'xml/');
define('_JS', Dfi\App\Config::getString('http.static') . 'js/');
